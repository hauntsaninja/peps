...
for any reason, the Steering Council could (publicly or privately) make or
request a (specific or non-specific) change to the composition of the
Typing Council.

We acknowledge that this is a not particularly democratic structure that puts
...
self-governance, regular cycling of membership and accountability to the
